...
function App() {
  ...
  const [skaicius1, setSkaicius1] = useState(100);
  ...
  const inputSkaicius1 = e => {
    setSkaicius1(e.target.value);
    console.log(e.target.value);
  }

  const inputSkaicius2 = e => {
  ...
  const pridetiVarda = () => {
    setVardas(vardas) && setSvoris(svoris);
    console.log(vardas);
    console.log(svoris);
  }
    ...
    <div className="App">
      <header className="App-header">
        ...
        <fieldset>
          ...
          <br/>
          <button onClick={pridetiVarda}>ĮVESTI:</button>
          <div className='green-field'></div>
        </fieldset>
        <fieldset>
          <legend>#3</legend>
          <input type='number' value={skaicius1} onChange={inputSkaicius1}></input>
          <br/>
          <input type='number' value={skaicius2} onChange={inputSkaicius2}></input>
        </fieldset>
      </header>
    </div>
  );
